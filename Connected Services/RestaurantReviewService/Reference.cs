...
namespace Lab10.RestaurantReviewService {
    ...
    public partial class RestaurantInfo : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        private Lab10.RestaurantReviewService.Address LocationField;
        ...
        public Lab10.RestaurantReviewService.Address Location {
            get {
    ...
    public interface IRestaurantReviewService {
        ...
        Lab10.RestaurantReviewService.RestaurantInfo GetRestaurantByName(string name);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRestaurantReviewService/GetRestaurantByName", ReplyAction="http://tempuri.org/IRestaurantReviewService/GetRestaurantByNameResponse")]
        System.Threading.Tasks.Task<Lab10.RestaurantReviewService.RestaurantInfo> GetRestaurantByNameAsync(string name);
        ...
        Lab10.RestaurantReviewService.RestaurantInfo[] GetRestaurantsByRating(int rating);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRestaurantReviewService/GetRestaurantsByRating", ReplyAction="http://tempuri.org/IRestaurantReviewService/GetRestaurantsByRatingResponse")]
        System.Threading.Tasks.Task<Lab10.RestaurantReviewService.RestaurantInfo[]> GetRestaurantsByRatingAsync(int rating);
        ...
        bool SaveRestaurant(Lab10.RestaurantReviewService.RestaurantInfo restInfo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRestaurantReviewService/SaveRestaurant", ReplyAction="http://tempuri.org/IRestaurantReviewService/SaveRestaurantResponse")]
        System.Threading.Tasks.Task<bool> SaveRestaurantAsync(Lab10.RestaurantReviewService.RestaurantInfo restInfo);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IRestaurantReviewServiceChannel : Lab10.RestaurantReviewService.IRestaurantReviewService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class RestaurantReviewServiceClient : System.ServiceModel.ClientBase<Lab10.RestaurantReviewService.IRestaurantReviewService>, Lab10.RestaurantReviewService.IRestaurantReviewService {
        ...
        public Lab10.RestaurantReviewService.RestaurantInfo GetRestaurantByName(string name) {
            return base.Channel.GetRestaurantByName(name);
        }
        
        public System.Threading.Tasks.Task<Lab10.RestaurantReviewService.RestaurantInfo> GetRestaurantByNameAsync(string name) {
            return base.Channel.GetRestaurantByNameAsync(name);
        }
        
        public Lab10.RestaurantReviewService.RestaurantInfo[] GetRestaurantsByRating(int rating) {
            return base.Channel.GetRestaurantsByRating(rating);
        }
        
        public System.Threading.Tasks.Task<Lab10.RestaurantReviewService.RestaurantInfo[]> GetRestaurantsByRatingAsync(int rating) {
            return base.Channel.GetRestaurantsByRatingAsync(rating);
        }
        
        public bool SaveRestaurant(Lab10.RestaurantReviewService.RestaurantInfo restInfo) {
            return base.Channel.SaveRestaurant(restInfo);
        }
        
        public System.Threading.Tasks.Task<bool> SaveRestaurantAsync(Lab10.RestaurantReviewService.RestaurantInfo restInfo) {
